...
exports.v1 = function (settings) {
    ...
    return async function (request, h) {
        ...
        if (!request.query.oauth_token) {
            ...
            return h
                .redirect(`${settings.provider.auth}?${internals.queryString(authQuery)}`)
                .takeover();
        }
...
exports.v2 = function (settings) {
    ...
    return async function (request, h) {
        ...
        const get = async function (uri, params) {
            ...
            try {
                let { res: profileRes, payload: profilePayload } = await Wreck[settings.provider.profileMethod](uri + getQuery, getOptions);
...
internals.refreshRedirect = function (request, name, protocol, settings, h) {
    ...
    return h
        .response(`<html><head><meta http-equiv="refresh" content="0;URL='${refreshUrl}'"></head><body></body></html>`)
        .takeover();
};
